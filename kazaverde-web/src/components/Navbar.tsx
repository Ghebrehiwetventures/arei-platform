...
export default function Navbar() {
  ...
  if (isHome) {
    return (
      <nav className="nav home-nav anim-fd">
        <Link className="logo home-logo" to="/" onClick={closeMenu}>
          AREI
        </Link>
        ...
        <button
          type="button"
          className="nav-hamburger hide-desktop home-nav-hamburger"
        ...
        <div className={`nc-mobile home-nav-mobile${menuOpen ? " open" : ""}`}>
          ...
          <a href="#contact" onClick={closeMenu}>Investor Enquiry</a>
        </div>

        <div className="nr">
          <a className="home-nav-cta" href="#contact">
            Investor Enquiry
          </a>
        </div>
      </nav>
