    ...
    translation: {
      ...
      privacy: {
        ...
        sections: [
          ...
          ["Cookies", "Almost none.", "The Cape Verde Real Estate Index uses minimal browser storage. Vercel Web Analytics is cookieless. The only marketing cookie is the Meta Pixel, which loads only if you accept marketing cookies in the banner — decline and it never runs. Otherwise the only persistent storage is localStorage for your saved properties and your cookie choice. For the full breakdown, see the <1>Cookie Policy</1>."],
      ...
      cookies: {
        ...
        sub:
          "The Cape Verde Real Estate Index is built to minimise data collection. It is cookieless by default — the only marketing tracker, the Meta Pixel, loads only if you opt in, and you can decline.",
        ...
        notUsed: [
          "No marketing or advertising tracking unless you opt in",
          "No tracking cookies of any kind if you decline",
          "We never sell or rent your personal data",
          "No personal profiling beyond Meta's standard pixel events",
        ],
    ...
    translation: {
      ...
      privacy: {
        ...
        sections: [
          ...
          ["Cookies", "Quase nenhuns.", "O Cape Verde Real Estate Index usa armazenamento mínimo no navegador. A Vercel Web Analytics não usa cookies. O único cookie de marketing é o Meta Pixel, que só é carregado se aceitar os cookies de marketing no banner — se recusar, nunca corre. Caso contrário, o único armazenamento persistente é o localStorage para imóveis guardados e a sua escolha de cookies. Para a explicação completa, consulte a <1>Política de Cookies</1>."],
      ...
      cookies: {
        ...
        sub:
          "O Cape Verde Real Estate Index foi construído para minimizar a recolha de dados. Não usa cookies por defeito — o único tracker de marketing, o Meta Pixel, só é carregado se aceitar, e pode recusar.",
        ...
        notUsed: [
          "Sem tracking de marketing ou publicidade sem o seu consentimento",
          "Sem cookies de tracking de qualquer tipo se recusar",
          "Nunca vendemos nem alugamos os seus dados pessoais",
          "Sem perfis pessoais além dos eventos padrão do pixel da Meta",
        ],
