  ...
  en: {
    translation: {
      ...
      market: {
        ...
        title: "Cape Verde property market overview.",
        intro: "See how many public listings we currently track and the median asking price by island.",
        disclosure: "Based on monitored public listings and asking prices. Not completed sale prices or valuations.",
        freshness: "Sources are checked daily.",
        loading: "Loading market data…",
        unavailable: "Market data unavailable",
        trackedListings: "Tracked listings",
        islandsRepresented: "Islands represented",
        sourcesRepresented: "Sources represented",
        inPriceSample: "In the price sample",
        islandEyebrow: "Prices by island",
        islandHeading: "Median asking prices by island.",
        islandIntro: "A quick view of what properties are currently advertised for. The figures combine different property types and should not be used to value a specific property.",
        tableIsland: "Island",
        tableTracked: "Tracked listings",
        tableSample: "In price sample",
        tableMedian: "Median asking price",
        tableNote: "The price sample includes numeric asking prices from €10,000 to €5,000,000. Medians are shown only for islands with at least 5 listings in the sample.",
        dataEyebrow: "About the data",
        dataHeading: "What these figures mean.",
        dataPoints: [
          "Prices are the amounts shown in public listings, not completed sale prices.",
          "Coverage is partial; not every property or source is included.",
          "We try to identify duplicate listings, but some may remain.",
          "Check the original source before relying on a listing.",
          "Data updates as daily source checks complete.",
        ],
        dataLink: "Read how the index works →",
      },
      marketNews: {
        eyebrow: "Market News",
      ...
      about: {
        ...
        sub: "We collect public property listings from multiple sources, organise the main details and link each listing back to the original page.",
        sections: [
          {
            eyebrow: "What it is",
            heading: "A listing index, not a sales-price index.",
            body: "The site helps users search and compare the public listings we currently track. It does not represent every property for sale and it does not measure completed sale prices.",
          },
          {
            eyebrow: "How it works",
            heading: "How listings are handled.",
            list: [
              "Each listing links to its original public source.",
              "We organise fields such as price, location, property type and size when the source provides enough information.",
              "We try to identify duplicate ads for the same property. Some duplicates may remain.",
              "Missing information stays blank when the source does not provide enough evidence.",
              "Tracked sources are checked daily. Each listing shows the date of its most recent successful check.",
            ],
          },
          {
            eyebrow: "Limits",
            heading: "What the data does not cover.",
            list: [
              "Prices are asking prices, not completed sale prices or valuations.",
              "Coverage is partial. Private sales, off-market properties and untracked sources are not included.",
              "We do not verify ownership, title, debts, permits, taxes or the legal status of a property.",
              "The data should not be used as a valuation of a specific property.",
            ],
          },
          {
            eyebrow: "Publisher",
            heading: "Published by AREI.",
            body: "The Cape Verde Real Estate Index is published by AREI. AREI is not a broker or estate agency and does not handle offers, deposits, contracts or property sales.",
          },
        ],
        disclosure: "Based on monitored public listings and asking prices. Not completed sale prices or valuations.",
      },
  ...
  pt: {
    translation: {
      ...
      market: {
        ...
        eyebrow: "Visão geral do mercado",
        title: "Visão geral do mercado imobiliário de Cabo Verde.",
        intro: "Veja quantos anúncios públicos acompanhamos atualmente e o preço mediano pedido por ilha.",
        ...
        freshness: "As fontes são verificadas diariamente.",
        loading: "A carregar dados de mercado…",
        unavailable: "Dados de mercado indisponíveis",
        trackedListings: "Anúncios acompanhados",
        islandsRepresented: "Ilhas representadas",
        sourcesRepresented: "Fontes representadas",
        inPriceSample: "Na amostra de preços",
        islandEyebrow: "Preços por ilha",
        islandHeading: "Preços medianos pedidos por ilha.",
        islandIntro: "Uma visão rápida dos preços anunciados atualmente. Os valores combinam diferentes tipos de imóveis e não devem ser usados para avaliar um imóvel específico.",
        tableIsland: "Ilha",
        tableTracked: "Anúncios acompanhados",
        tableSample: "Na amostra de preços",
        tableMedian: "Preço mediano pedido",
        tableNote: "A amostra de preços inclui preços pedidos numéricos entre €10.000 e €5.000.000. As medianas são apresentadas apenas para ilhas com pelo menos 5 anúncios na amostra.",
        dataEyebrow: "Sobre os dados",
        dataHeading: "O que significam estes valores.",
        dataPoints: [
          "Os preços são os valores indicados nos anúncios públicos, não preços de vendas concluídas.",
          "A cobertura é parcial; não estão incluídos todos os imóveis nem todas as fontes.",
          "Tentamos identificar anúncios duplicados, mas alguns podem permanecer.",
          "Consulte a fonte original antes de confiar num anúncio.",
          "Os dados são atualizados à medida que as verificações diárias das fontes são concluídas.",
        ],
        dataLink: "Ler como o índice funciona →",
      },
      marketNews: {
      ...
      about: {
        ...
        sub: "Recolhemos anúncios públicos de imóveis de várias fontes, organizamos os detalhes principais e ligamos cada anúncio à página original.",
        sections: [
          {
            eyebrow: "O que é",
            heading: "Um índice de anúncios, não um índice de preços de venda.",
            body: "O site ajuda os utilizadores a pesquisar e comparar os anúncios públicos que acompanhamos atualmente. Não representa todos os imóveis à venda e não mede preços de vendas concluídas.",
          },
          {
            eyebrow: "Como funciona",
            heading: "Como os anúncios são tratados.",
            list: [
              "Cada anúncio liga à sua fonte pública original.",
              "Organizamos campos como preço, localização, tipo de imóvel e área quando a fonte fornece informação suficiente.",
              "Tentamos identificar anúncios duplicados do mesmo imóvel. Alguns duplicados podem permanecer.",
              "A informação em falta fica em branco quando a fonte não fornece evidência suficiente.",
              "As fontes acompanhadas são verificadas diariamente. Cada anúncio mostra a data da verificação bem-sucedida mais recente.",
            ],
          },
          {
            eyebrow: "Limitações",
            ...
            list: [
              "Os preços são preços pedidos, não preços de vendas concluídas nem avaliações.",
              "A cobertura é parcial. Vendas privadas, imóveis fora do mercado e fontes não acompanhadas não estão incluídas.",
              "Não verificamos a propriedade, o título, as dívidas, as licenças, os impostos ou o estado legal de um imóvel.",
              "Os dados não devem ser usados como avaliação de um imóvel específico.",
            ],
          },
          {
            eyebrow: "Publicador",
            heading: "Publicado pela AREI.",
            body: "O Cape Verde Real Estate Index é publicado pela AREI. A AREI não é um mediador imobiliário nem uma agência e não trata de propostas, depósitos, contratos ou vendas de imóveis.",
          },
        ],
        disclosure: "Com base em anúncios públicos monitorizados e preços pedidos. Não são preços de vendas concluídas nem avaliações.",
      },
