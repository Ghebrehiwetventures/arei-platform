  ...
  en: {
    translation: {
      ...
      detail: {
        ...
        report: {
          trigger: "Something wrong with this listing?",
          title: "Report this listing",
          intro: "Help us keep the index accurate. Reports are verified against the original source.",
          reason_sold: "Already sold or rented",
          reason_price: "Price is wrong",
          reason_duplicate: "Duplicate listing",
          reason_photos: "Photos don't match",
          reason_scam: "Looks like a scam",
          reason_other: "Something else",
          detailsLabel: "Details · optional",
          detailsPlaceholder: "e.g. the agent told me it sold in May",
          emailLabel: "Email · optional, if we may follow up",
          emailPlaceholder: "you@example.com",
          submit: "Send report",
          submitting: "Sending…",
          successTitle: "Thank you",
          successBody: "We'll verify this against the original source. If the listing has changed, the index updates automatically.",
  ...
  pt: {
    translation: {
      ...
      detail: {
        ...
        report: {
          trigger: "Algo errado com este anúncio?",
          title: "Reportar este anúncio",
          intro: "Ajude-nos a manter o índice preciso. Os reportes são verificados junto da fonte original.",
          reason_sold: "Já vendido ou arrendado",
          reason_price: "Preço errado",
          reason_duplicate: "Anúncio duplicado",
          reason_photos: "As fotos não correspondem",
          reason_scam: "Parece uma burla",
          reason_other: "Outro motivo",
          detailsLabel: "Detalhes · opcional",
          detailsPlaceholder: "ex.: o agente disse que foi vendido em maio",
          emailLabel: "Email · opcional, caso possamos contactar",
          emailPlaceholder: "voce@exemplo.com",
          submit: "Enviar reporte",
          submitting: "A enviar…",
          successTitle: "Obrigado",
          successBody: "Vamos verificar junto da fonte original. Se o anúncio mudou, o índice atualiza-se automaticamente.",
