-- Migration: Expose source quality stats RPC to anon/authenticated via SECURITY DEFINER
-- Date: 2026-03-25
...
REVOKE ALL ON FUNCTION public.get_source_quality_stats() FROM PUBLIC;
