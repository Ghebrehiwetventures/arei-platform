...
-- Run migrations 012-014, 019, and 020 in order in Supabase SQL Editor.
--
...
-- Migration 020 updates:
--   - public.get_source_quality_stats() to run as SECURITY DEFINER for anon/authenticated RPC access
