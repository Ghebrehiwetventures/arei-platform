...
function MarketNewsSocialAgentView() {
  ...
  if (loading) {
    return <div className="py-12 text-muted-foreground font-mono">Loading Market News social agent…</div>;
  }
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="grid grid-cols-1 xl:grid-cols-[0.85fr_1.15fr] gap-6">
        <div className="border border-foreground brutalist-shadow-sm bg-muted p-4 space-y-4">
          <div>
        ...
        <div className="space-y-4">
          {selectedDrafts.length === 0 && (
            <div className="border border-border bg-muted p-6 text-sm font-mono text-muted-foreground">
          ...
          {selectedDrafts.map((draft) => {
            ...
            return (
              <article key={draft.id} className="border border-foreground brutalist-shadow-sm bg-background p-4">
                <div className="flex flex-wrap items-start justify-between gap-3 mb-3">
                  <div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-[1fr_220px] gap-4">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-muted border border-border text-foreground p-3 text-sm font-mono leading-relaxed disabled:opacity-70"
                    />
                  </div>
                  <div className="space-y-3 text-xs font-mono">
                    <div>
                      ...
                      <div className="text-muted-foreground">{formatDateLabel(draft.approved_at)}</div>
                    </div>
                    <div>
                      <div className="label-style mb-1">Publish</div>
                      <div>{draft.publish_status}</div>
                      <div className="text-muted-foreground">{formatDateLabel(draft.publish_attempted_at)}</div>
                    </div>
...
type Tab = "dashboard" | "listings" | "sources" | "stats" | "agents" | "market-social";
