...
export const PRESETS: CarouselPreset[] = [
  {
    id: "what-100k",
    name: "What €100k buys you in Cape Verde",
    coverTitle: "What €100k buys you in Cape Verde",
  ...
  {
    id: "5-under-100k",
    name: "5 homes under €100k",
    coverTitle: "5 homes under €100k in Cape Verde",
    ...
    priceCap: 100000,
    allowMoment: false,
    captionAngle: "Five real, source-linked homes under €100k — indexed from across Cape Verde.",
  },
  {
    id: "what-200k",
    name: "What €200k buys you in Cape Verde",
    coverTitle: "What €200k buys you in Cape Verde",
    coverKicker: "// FROM THE INDEX",
    cta: "See source-linked listings from across Cape Verde.",
    listingsRequired: true,
    defaultListings: 3,
    priceCap: 200000,
    allowMoment: false,
    captionAngle: "What €200k actually buys in Cape Verde — real, source-linked listings.",
  },
  {
    id: "market-explained",
