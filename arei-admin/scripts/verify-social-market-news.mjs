...
assert(app.includes("canPublishInstagram"), "admin UI disables Instagram publish through local gate");
assert(app.includes("Copy"), "admin UI includes manual copy/export fallback");
assert(app.includes("Generate social drafts"), "admin UI includes generation action");
